...
WARNING: После выполнения описанных настроек особенности протокола аутентификации Kerberos, требуют обращаться к сервисам {dv} по адресу с доменным именем. При обращении к сайту по IP вход не удастся.
