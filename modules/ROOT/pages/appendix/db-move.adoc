...
* Если база данных не является единственной на сервере {dv}, xref:dev@mgmtconsole:servers:db-detach.adoc[отключите] БД от сервера {dv}.
...
** "xref:new-admin-console@platform:console:db-satellite.adoc[]" для программы {cns}.
====
