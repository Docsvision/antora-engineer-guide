...
. xref:6.1@platform:admin:debug.adoc[Задайте] значение параметра `TraceLevel` в конфигурационном файле Сервера приложений (модуля {pl}). Отладка работает при значениях `3` и `4`.
