...
. xref:new-admin-console@platform:admin:debug.adoc[Задайте] значение параметра `TraceLevel` в конфигурационном файле модуля {pl}. Отладка работает при значениях `3` и `4`.
