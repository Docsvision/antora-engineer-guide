...
.. Получите библиотеку `CryptoPro.Security.Cryptography.dll` (входит в комплект https://cryptopro.ru/products/net/downloads[КриптоПро .Net LibCore]) и поместите её по адресу `/usr/lib/docsvision/common`.
