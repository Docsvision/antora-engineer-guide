...
****
Начиная с модуля {pl} версии {pl-cu5}, настройку внешних хранилищ  можно выполнить двумя способами:

* При помощи программы {cns}, см. подробнее ниже
* Из интерфейса {of-mc}, см. подробнее раздел "xref:dev@mgmtconsole:servers:db-storage.adoc[]" в документации {of-mc}
****
