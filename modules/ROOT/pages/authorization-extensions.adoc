...
Данный раздел посвящён регистрации расширений авторизации в Linux версии системы 6.1. Создание собственных расширений {dv} описывается в разделе "xref:dv6@programmer:solutions:extensions/extensions.adoc[]" руководства по разработке.
